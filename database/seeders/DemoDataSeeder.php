...
class DemoDataSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $pats = [
            ...
            ['patient_id'=>'P-2024-002','name'=>'Maria Clara','date_of_birth'=>'1990-07-22','phone'=>'0933-222-3333','address'=>'456 Oak Ave, Brgy. Apopong, General Santos','medical_history'=>'Asthma','assigned_nurse_id'=>$nurse1->id,'assigned_doctor_id'=>$doc2->id,'last_visit'=>now()->subHours(4)],
            ['patient_id'=>'P-2024-003','name'=>'Pedro Penduko','date_of_birth'=>'1978-11-30','phone'=>'0933-333-4444','address'=>'789 Pine Rd, Brgy. Talomo, Davao City','medical_history'=>'Arthritis, High Cholesterol','assigned_nurse_id'=>$nurse2->id,'assigned_doctor_id'=>$doc1->id,'last_visit'=>now()->subHours(1)],
            ...
            ['patient_id'=>'P-2024-005','name'=>'Rizal Mercado','date_of_birth'=>'1965-05-20','phone'=>'0933-555-6666','address'=>'555 Rizal Ave, Brgy. Patag, Cagayan de Oro','medical_history'=>'Heart Disease, Hypertension','assigned_nurse_id'=>$nurse1->id,'assigned_doctor_id'=>$doc1->id,'last_visit'=>now()->subDays(2)],
